...
3. Navigate to repo and type in terminal `git remote add upstream https://github.com/dsa3101-2310-01-library/dsa3101-2310-01-library.git` (only need to do this once)
